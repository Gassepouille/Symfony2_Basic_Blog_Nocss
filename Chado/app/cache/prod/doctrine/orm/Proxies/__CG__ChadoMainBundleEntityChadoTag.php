 ...
 */
class ChadoTag extends \Chado\MainBundle\Entity\ChadoTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'articles', 'tagname');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChadoTag $proxy) {
