 ...
 */
class ChadoArticle extends \Chado\MainBundle\Entity\ChadoArticle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'tags', 'comments', 'title', 'online', 'slug', 'content', 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChadoArticle $proxy) {
