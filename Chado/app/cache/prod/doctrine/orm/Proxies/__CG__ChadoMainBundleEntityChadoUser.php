 ...
 */
class ChadoUser extends \Chado\MainBundle\Entity\ChadoUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'comments', 'nickname', 'mail', 'password', 'website', 'twitter', 'salt', 'token', 'date', 'roles');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChadoUser $proxy) {
