...
namespace Proxies\__CG__\Chado\MainBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ChadoComments extends \Chado\MainBundle\Entity\ChadoComments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'replies', 'parent', 'article', 'content', 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChadoComments $proxy) {
    ...
    public function addReply(\Chado\MainBundle\Entity\ChadoComments $replies)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReply', array($replies));

        return parent::addReply($replies);
    }
    ...
    public function removeReply(\Chado\MainBundle\Entity\ChadoComments $replies)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReply', array($replies));

        return parent::removeReply($replies);
    }
